...
## Springs Story Section — Responsive + Animated
- [x] Hide landscape (s2) images on mobile, show on md+ only
- [x] Add rich scroll-triggered animations throughout (go nuts)
- [x] Fully responsive layout — mobile, tablet, desktop verified
- [x] Certification badges animated and polished at all breakpoints
- [x] Portrait (s1) image visible at all breakpoints

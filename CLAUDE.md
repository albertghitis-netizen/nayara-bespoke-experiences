...
- `deliverables/gardens-organic-strategy-briefing.html` — plain-language executive briefing on the Gardens organic strategy, in the house design system. Sendable to leadership.
- `deliverables/integrated-demand-strategy-v2.html` — the integrated demand strategy.
- `deliverables/search-demand-plan-v2.md` — the search demand plan.
- `deliverables/tented-paid-search-audit.html` — the Tented paid-search audit (reference for method and tone).
- `reference/original-seo-audit.md` — independent external technical and competitive audit. Directionally right on missing hotel schema and image layout shift, overstated on crawlability and "all four" claims.
- `reference/strategy-critique.md` — a critique of an earlier version of the strategy framework; several gaps it names are already closed.
- `reference/integrated-growth-strategy.md` — the ownership growth-strategy deck text.

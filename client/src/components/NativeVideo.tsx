    ...
    <div className="relative w-full h-full" onClick={handleTapToPlay}>
      ...
      {hasAudio && isLoaded && (
        <button
          ...
          className={`absolute top-3 left-14 z-[60] ${mobileAudio ? 'flex' : 'hidden md:flex'} items-center gap-2 h-9 px-3.5 rounded-full backdrop-blur-md border border-white/10 transition-all duration-300 group cursor-pointer`}

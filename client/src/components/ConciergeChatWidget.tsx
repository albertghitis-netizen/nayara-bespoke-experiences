...
export default function ConciergeChatWidget({ palette }: ConciergeChatWidgetProps = {}) {
  ...
  const bg = palette?.pillBg ?? (autoPalette ? `${autoPalette.navPillBg}B3` : isCostaRica ? "rgba(134,139,117,0.8)" : isBrandHome ? "rgba(59,43,38,0.8)" : "rgba(59,43,38,0.8)");  // Match nav pill background

      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center gap-0.5 rounded-full bg-[#E9E5D8] shadow-xl px-5 py-3 hover:bg-[#ddd9cc] transition-colors group cursor-pointer"

/**
 * Nayara Resorts — Concierge Chat Panel (HEAVY)
 * Contains Streamdown (shiki, mermaid, katex) and all chat logic.
 * Only loaded dynamically when user clicks the Concierge button.
 */
...
export default function ConciergeChatPanel({ isOpen, onClose }: ConciergeChatPanelProps) {

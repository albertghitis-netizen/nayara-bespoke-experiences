  ...
  "costa-rica": {
    ...
    esgReport: {
      ...
      timeline: [
        ...
        { year: "2026", title: "Costa Rica\u2019s National Shift", desc: "Costa Rica formally evolves from sustainable to regenerative tourism. CANAECO partners with Virtuoso and Beyond Green to set new global benchmarks, and 134 companies earn national recognition for sustainable tourism commitment. Nayara\u2019s model of ecological restoration and community investment is cited as a leading example of the country\u2019s vision." },
      ],
      certifications: [
      ...
      carbonOffset: {
        ...
        paragraphs: [
          "Nayara Resorts is committed to reducing its environmental impact through a structured carbon offsetting strategy. The goal is to achieve and maintain carbon neutrality, offsetting Scope 1 and Scope 2 greenhouse gas emissions through the acquisition of certified carbon credits. Over time, this initiative will be progressively expanded to include additional areas of impact. This commitment is amplified by Costa Rica\u2019s national energy infrastructure: more than 99% of the country\u2019s electricity is generated from renewable sources including hydroelectric, geothermal, wind, and solar power, and the government\u2019s National Decarbonization Plan targets full carbon neutrality by 2050.",
      ...
      narrative: {
        ...
        paragraphs: [
          ...
          "Nayara\u2019s approach is part of a broader national movement. Costa Rica \u2014 where over 25% of the land is protected and more than 99% of electricity comes from renewable sources \u2014 is now evolving from sustainable tourism to regenerative tourism: an approach that goes beyond preservation to actively restore ecosystems and strengthen communities. Two-thirds of visitors cite ecotourism as a primary reason for choosing Costa Rica, and the country\u2019s National Chamber of Ecotourism (CANAECO) is partnering with organizations like Virtuoso and Beyond Green to set new global benchmarks for luxury hospitality that delivers verifiable environmental and social impact. Nayara\u2019s decade-long transformation of degraded land into thriving rainforest places it at the forefront of this national vision.",
          "The distinction matters. Sustainability asks: how do we reduce harm? Regenerative hospitality asks a different question entirely: how do we leave this place better than we found it? Where a sustainable hotel might offset its carbon footprint to reach net zero, a regenerative one aims for net positive \u2014 giving back more to its ecosystems and communities than it consumes. Nayara\u2019s reforestation of a barren cattle ranch into thriving rainforest is not an offset strategy. It is an act of ecological creation. The 50,000 plants restored, the biologist-designed frog habitats, the wildlife corridors reconnecting fragmented forest \u2014 these go far beyond balancing a ledger.",
          "Regenerative hospitality also demands a fundamentally different business model. Rather than extracting value from a place for distant shareholders, a regenerative hotel embeds itself within local ecosystems \u2014 understanding how communities, economies, and natural environments sustain one another, and designing operations that strengthen those relationships. Nayara was built with this philosophy from the beginning: 90% local workforce, the largest employer in La Fortuna, subsidized housing that remains accessible regardless of employment, and community programs that extend far beyond the property gates. The hotel does not exist apart from its place. It is an integral part of it.",
          ...
          "Perhaps most importantly, regenerative hospitality involves guests in the process of renewal. At Nayara, this happens naturally: guided reforestation tours where visitors plant native species, dawn birdwatching that deepens ecological awareness, and the simple act of slowing down in a place that asks nothing of you except presence. Guests do not merely witness conservation \u2014 they participate in it. And in doing so, they regenerate themselves: returning home not just rested, but fundamentally shifted in how they relate to the natural world.",
        ],
      },
    },
  ...
  "bocas-del-toro": {
    ...
    blogs: [
      ...
      },
      {
        ...
        url: "/bocas-del-toro/sustainability",
      },

...
export const gastronomyBlogPost: BlogPostData = {
  ...
  tags: [],
  readingTime: 8,
  heroImage: "/manus-storage/three-kitchens-hero_ff6ac7fb.jpg",
  heroVideo: {
...
<p><strong>La Terraza</strong> is the open-air family restaurant at Nayara Gardens, serving à-la-carte local and international cuisine with unparalleled views of Arenal Volcano from every table. The kitchen sources only local produce and fresh ingredients — fish, meat, and seasonal staples — and carries hundreds of bottles of wines from around the world. Don't miss sitting at the <strong>Bar Azul</strong>, where the bartender crafts his or her own tropical creations on the spot. Live local musicians perform every night, adding to the lively, warm ambiance that makes La Terraza the heart of the Gardens dining experience.</p>
<p><strong>Asia Luna</strong> is a culinary crossroads — a place where flavors, peoples, and cultures converge in the middle of the rainforest. The kitchen experiments with local ingredients and Asian cooking techniques to offer a unique interpretation of traditional Asian cuisine, putting Costa Rica's fresh produce together with Asian haute fare. Try the Chef's signature <strong>Nayara Roll</strong>, made with sweet plantains and cooked chicken, or the <strong>Grilled Yellow Fin Tuna</strong> with sautéed vegetables. An intimate, stylish spot with an outdoor terrace and an inside sushi bar, Asia Luna is unlike any restaurant you will find anywhere else.</p>
<p><strong>Nostalgia Wine Bar</strong> invites you to indulge in the finest Latin American and European vintages through an exclusive wine dispensing system directly imported from Italy. The atmosphere is warm and inviting — rich leather, warm wood, and soft candlelight — creating a cozy, intimate setting unlike any other wine bar in the region. Savor a delightful selection of bites and drinks whether sitting at the bar or out on the balcony, where the garden ponds shimmer in the evening light. The certified sommelier leads structured tastings that illuminate terroir, vintage, and technique — always in service of pleasure, never pedantry.</p>`,
      image: {
    ...
    },
    {
      ...
      content: `<p><a href="https://nayarasprings.com" target="_blank">Nayara Springs</a> elevates the experience with two restaurants that define the upper register of Nayara's culinary range.</p>
<p><strong>Amor Loco</strong> is the signature dining experience at Nayara Springs Relais &amp; Châteaux, where the chefs take you on a curated culinary journey through Costa Rica's rich tapestry of flavors and ingredients. A selection of dishes in small portions showcases the chefs' skills and creativity, mixing tradition with innovation. Try Pejibaye — peach palm fruit — alongside coffee and fresh seafood as they tell a rich cultural story. Every plate connects you with the land and creates delicious memories that linger long after the meal ends.</p>
...
<p><strong>Mis Amores</strong> at Nayara Springs Relais &amp; Châteaux showcases the refined flavors of Northern Italy, offering a cuisine that reflects the chef's passion for genuine ingredients, deep respect for flavor, and personal interpretation of traditional recipes. Crafted from old family recipes, the menu is a culinary journey through many cities of Italy — highlights include wood-fired pizzas and a live-cheese pasta dish prepared tableside. The outdoor setting allows for spectacular views of Arenal Volcano from every table, making every meal as beautiful as it is delicious.</p>`,
    },
    {
      heading: "Nayara Tented Camp: Fire, Earth, and Open Air",
      content: `<p>At <a href="https://nayaratentedcamp.com" target="_blank">Nayara Tented Camp</a>, <strong>Ayla</strong> presents Mediterranean cuisine infused with Costa Rican touches, and it is here that the philosophy of cooking with fire reaches its fullest expression. The open-fire grill is central to Ayla's identity, meats are slow-cooked over native hardwoods, vegetables are charred to bring out their natural sweetness, and even desserts incorporate smoke and flame.</p>
<p>Savour modern Mediterranean dishes with a Middle Eastern touch in an elegant open-air tent with incredible views of the infinity pool, the rainforest, and the majestic Arenal Volcano. The menu draws from the Eastern Mediterranean: lamb kofta, grilled octopus, flatbreads from the wood-fired oven, and mezze platters designed for sharing. After dinner, enjoy traditional cocktails and spirits at <strong>Henry's Bar</strong> next door, featuring a fireplace and library, where you can sit back, listen to music, and let time pass with one of our specialty drinks in hand.</p>
`,
      image: {
...
<p>Lyla's is perfect for families. Children discover flavors they've never encountered before, and the ritual of choosing becomes a moment of genuine decision-making. Parents watch their kids taste guanabana for the first time, or dark chocolate infused with local cacao, and see the joy of discovery on their faces. It's not just dessert, it's an introduction to the world through taste. Every scoop is a small adventure, and every visit becomes a memory the family carries home.`,
      image: {
        src: "/manus-storage/Layla_s_NayaraGardens_1_d5454c55.jpg",
        alt: "Lyla's Gelato at Nayara Gardens, handcrafted tropical flavors with marshmallows and sprinkles",

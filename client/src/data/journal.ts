...
const blogArticles: JournalEntry[] = [
  {
    ...
    property: "brand",
    type: "article",
    image: "/manus-storage/summer-of-you-card_691d8a1a.jpeg",
  ...
  {
    id: "ocean-habitat-restoration",
    title: "Ocean Habitat Restoration: Building a City Beneath the Sea",
    url: "/ocean-habitat-restoration",
    property: "bocas-del-toro",
    type: "article",
    image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/bocas-aerial-villas-turquoise_858d4570.jpg",
    excerpt: "In partnership with Caribbean Coral Restoration, Nayara Bocas del Toro is restoring one of the Caribbean's most threatened ocean habitats — 500+ coral fragments outplanted, 3 active sites, and a living reef rising from the foundation up.",
    featured: true,
    date: "2026-06-01",
  },
  {

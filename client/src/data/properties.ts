...
const exploreNayaraExperiences: Excursion[] = [
  // ── Nature & Exploration (on-property) ──
  {
    ...
    verticalVideo: "/manus-storage/bird-watching-vertical_28d5ab74.mp4",
    featured: true,
    placeholder: false,
    category: "nature",
  ...
  },
  {
    ...
    verticalVideo: "/manus-storage/tonys-sloth-tour-vertical_5fe1cb6a.mp4",
    featured: true,
    placeholder: false,
    category: "nature",
    section: "explore-nayara",
...
const exploreArenalExperiences: Excursion[] = [
  ...
  },
  {
    ...
    videoDesktop: "/manus-storage/rio-celeste-clip_50a58276.mp4",

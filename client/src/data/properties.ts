...
const CDN = {
  ...
  crToucan: "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/costa-rica-toucan_1c677859.mp4",
...
const exploreNayaraExperiences: Excursion[] = [
  ...
  // ── Wellness (on-property) ──
  {
    id: "hatha-yoga",
    name: "Hatha Yoga",
    subtitle: "Slow-paced, alignment-focused practice in the Shala Sukha pavilion",
    duration: "60 min",
    difficulty: "All levels",
    suggestedTime: "8:15 AM",
    weeklySchedule: ["Monday 8:15 AM", "Wednesday 8:15 AM", "Thursday 8:15 AM", "Saturday 8:15 AM"],
    description: "A slower, intentional practice focused on holding postures, building awareness, and deepening alignment. Each session is guided by our resident instructor in the open-air Shala Sukha pavilion, surrounded by rainforest canopy. Suitable for all levels — a grounding way to begin the day.",
    highlights: ["Alignment-focused postures", "All levels welcome", "Shala Sukha rainforest pavilion"],
    image: "/manus-storage/c79047e9-cf9a-4757-bddb-f4893a920cab(1)_db84b658.jpg",
    featured: true,
    placeholder: false,
    category: "wellness",
  ...
  // ── Culinary (on-property) ──
  {
    ...
    subtitle: "Guided pranayama and stillness in the Shala Sukha pavilion",
    duration: "45 min",
    difficulty: "All levels",
  ...
  },
  {
    id: "vinyasa-yoga",
    name: "Vinyasa Yoga",
    subtitle: "Active, flowing sequences in the Shala Sukha pavilion",
    duration: "60 min",
    difficulty: "All levels",
    suggestedTime: "8:15 AM",
    weeklySchedule: ["Tuesday 8:15 AM", "Friday 8:15 AM", "Sunday 8:15 AM"],
    description: "A more dynamic, breath-linked practice that builds heat and energy through flowing sequences. Our instructor adapts the intensity to the group, making it accessible whether you are new to yoga or experienced. Set in the same open-air Shala Sukha pavilion above the rainforest.",
    highlights: ["Dynamic flowing sequences", "All levels welcome", "Shala Sukha rainforest pavilion"],
  ...
  },
  {
    ...
    image: "/manus-storage/la-estrella-mas_ef4bfbad.jpg",
  ...
  // Rio Celeste moved to exploreArenalExperiences
  {
    id: "birdwatching",
    name: "Birdwatching",
    ...
    verticalVideo: "/manus-storage/3336C767-C6CA-487E-87BE-5C8F72935519_9211581e.mov",
    featured: true,
    placeholder: false,
    category: "nature",
    section: "explore-nayara",
  ...
  },
  {
    ...
    image: "/manus-storage/frog-red-eyed_bd455b87.jpg",
    videoDesktop: "/manus-storage/night-frog-tour-clip_564600db.mp4",
    verticalVideo: "/manus-storage/A60BA5F4-D33F-4C31-8F46-51FB28B84DFB(1)_42d14c8f.mov",
    featured: true,
    placeholder: false,
    category: "nature",
...
const exploreArenalExperiences: Excursion[] = [
  // ── Nature & Exploration (off-property) ──
  {
    ...
    image: "/manus-storage/hanging-bridges-new_1dd31185.jpg",

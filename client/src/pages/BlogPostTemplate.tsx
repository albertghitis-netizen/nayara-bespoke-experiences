...
export default function BlogPostTemplate({ post, hideNav, hideHero, heroAspect }: BlogPostTemplateProps) {
  ...
  const shareBg = PALETTE.espresso;
  const exploreBg = sourcesBg === PALETTE.cream ? PALETTE.stone : PALETTE.cream;
                ...
                <figure className="my-10 flex flex-col items-center">
                  <div className="relative w-full max-w-2xl">
                    <img
                      ...
                      loading="lazy"
                    />
                    {section.image.aiGenerated && (
                      <span
                        className="absolute bottom-3 left-3 px-2.5 py-1 rounded text-[10px] tracking-[0.1em] uppercase backdrop-blur-sm"
                        style={{ fontFamily: "var(--font-body)", fontWeight: 500, backgroundColor: "rgba(0,0,0,0.55)", color: "rgba(255,255,255,0.9)" }}
                      >
                        Generated with AI
                      </span>
                    )}
      ...
      <section style={{ backgroundColor: shareBg }}>
        <div className="max-w-3xl mx-auto px-8 md:px-16 pt-12 pb-12 text-center">
          <p
            ...
            style={{ fontFamily: "var(--font-body)", fontWeight: 600, color: "#D4A853" }}
          >
            Share This Post
          </p>
          <div className="flex items-center justify-center gap-6">
            ...
            >
              <svg className="w-6 h-6 transition-all duration-300 group-hover:scale-110" fill="#FFFFFF" style={{ opacity: 0.7 }} viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a
            ...
            >
              <svg className="w-6 h-6 transition-all duration-300 group-hover:scale-110" fill="none" stroke="#FFFFFF" style={{ opacity: 0.7 }} strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
            </a>
            <button
            ...
            >
              <svg className="w-6 h-6 transition-all duration-300 group-hover:scale-110" fill="none" stroke="#FFFFFF" style={{ opacity: 0.7 }} strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
            </button>
          </div>
        </div>
      </section>

            ...
            {filterTabs.map((tab) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-[11px] tracking-[0.12em] transition-all duration-300 border ${
                  activeFilter === tab
                    ? "bg-[#3B2B26] border-[#3B2B26] text-white"
                    : "bg-transparent border-[#3B2B26]/20 text-[#3B2B26]/60 hover:border-[#3B2B26] hover:text-[#3B2B26]"
                }`}
                ...
                <div key={dest.id} className="group">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="px-5 py-2 rounded-full text-[11px] tracking-[0.12em] border border-[#3B2B26] text-[#3B2B26] hover:bg-[#3B2B26] hover:text-white transition-all duration-300"
                      style={{ ...body, fontWeight: 500 }}
                    >
                      Reserve
                    </a>

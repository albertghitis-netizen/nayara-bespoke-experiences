...
const CDN = {
  ...
  heroMobile: "/manus-storage/F1892DC2-0D23-4EF9-93E3-03C380627DE8(3)_7cd664d4.MOV",
};
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      <div className="absolute inset-0">
        <NativeVideo src={isMobile ? CDN.heroMobile : CDN.heroVideo} className="w-full h-full object-cover" loop={false} />

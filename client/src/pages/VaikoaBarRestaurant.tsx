/**
 * VAIKOA BAR RESTAURANT , Dining Detail Page
...
export default function VaikoaBarRestaurant() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Vaikoa Bar is a casual gathering place for drinks and light bites. Enjoy refreshing beverages and island-inspired snacks in a laidback atmosphere perfect for making new friends and sharing island stories.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Experience the warmth of island hospitality and the spirit of Rapa Nui in an inviting and relaxed setting.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Join us at Vaikoa Bar for drinks and the authentic spirit of Rapa Nui.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation , Coming Soon"))}

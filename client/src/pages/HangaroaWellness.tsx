      ...
      <section className={sectionPadding} style={{ backgroundColor: PALETTE.gradientEnd }}>
        <div className={maxW}>
          <AnimateOnScroll variants={fadeUp}>
            ...
            >
              The Manavai Spa draws from Rapa Nui's Polynesian heritage, using island botanicals and
              traditional techniques. Each treatment carries a name in the Rapa Nui language, connecting
              you to the island's living culture while restoring body and spirit in one of the most

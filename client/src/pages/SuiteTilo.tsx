...
export default function SuiteTilo() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              The Suites Tilo are our top-of-the-line accommodations. Every elegant and spacious Suite looks out over the sublime tranquility of the oasis into the Salt Mountain Range and the Andean hills. Touches of the local culture are everywhere, from handwoven throws to macramé hangings, complementing the natural fabric palette of the suite.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              An outdoor rain shower to wash under the night glowing stars elevates the wilderness experience and adds to the privacy.
            </p>
          </div>
        </motion.div>
      </div>
...
function AmenitiesSection() {
  const amenities = [
    "Elegant and spacious suite layout",
    "Uninterrupted mountain and oasis views",
    "Handwoven throws and macramé details",
    "Outdoor rain shower under the stars",
    "Natural fabric palette throughout",
    "Complimentary Wi-Fi",
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Experience Ultimate Desert Luxury
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Suite Tilo offers the pinnacle of Atacama hospitality with unmatched views and refined comfort.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation — Coming Soon"))}

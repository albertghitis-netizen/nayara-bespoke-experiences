...
const SWATCHES = [
  ...
  { num: 4, name: "Dark Olive", hex: "#525642", role: "Gardens primary, Tented Camp secondary" },
  ...
  { num: 12, name: "Clover Green", hex: "#286241", role: "(available)" },
...
const PROPERTY_PALETTE_DATA = [
  ...
  },
  {
    ...
    slug: "gardens",
    landscape: "Dark Olive",
    desc: "Dark Olive (#525642, swatch #22) — warm olive green evoking the canopy of Arenal",

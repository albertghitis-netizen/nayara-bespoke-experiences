    ...
    <div className="min-h-screen" style={{ backgroundColor: P.bg }}>
      ...
      <section className="py-20 md:py-28 px-6 md:px-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Suspended within the lush tropical canopy of Bocas del Toro, the Treehouse blends childhood wonder with refined luxury. Wraparound terraces, open-air living, and the sounds of the Caribbean jungle create an experience unlike any other. Full details arriving soon.
          </p>
          <Link
            href="/bocas-del-toro"

/*
 * GARDENS WELLNESS — Dedicated wellness/spa sub-page
 * Uses shared Costa Rica treatments data with Gardens palette
 */
...
export default function GardensWellness() {
      ...
      <section className={sectionPadding} style={{ backgroundColor: PALETTE.gradientEnd }}>
        <div className={maxW}>
          <AnimateOnScroll variants={fadeUp}>
            ...
            >
              The Nayara Spa draws from Costa Rica's rich natural pharmacy — volcanic mud, organic
              coffee, tropical cacao, and rainforest botanicals. Surrounded by the sounds of the jungle
              and the warmth of volcanic hot springs, every treatment is designed to restore balance.
            </p>
          </AnimateOnScroll>

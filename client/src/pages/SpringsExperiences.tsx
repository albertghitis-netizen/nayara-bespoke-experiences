/*
 * SPRINGS EXPERIENCES — Dedicated experiences sub-page
 * Uses shared Costa Rica excursions data with Springs palette
 */
...
export default function SpringsExperiences() {

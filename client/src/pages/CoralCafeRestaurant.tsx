/**
 * CORAL CAFÉ RESTAURANT — Dining Detail Page
...
export default function CoralCafeRestaurant() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="relative overflow-hidden rounded-sm aspect-[4/3]" style={{ backgroundColor: P.primary }}>
            <div className="w-full h-full flex items-center justify-center">
              <p style={{ ...body, color: P.white }}>Café Image Coming Soon</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Coral Café is our laidback poolside dining venue, perfect for casual meals and refreshing beverages. Enjoy fresh Caribbean cuisine in a relaxed tropical atmosphere with views of the pool and surrounding gardens.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Whether it's breakfast, lunch, or afternoon refreshments, Coral Café is your perfect escape for casual island dining.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Experience casual Caribbean dining at Coral Café with tropical views and refreshing cuisine.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation — Coming Soon"))}

...
export default function Kainga() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: P.bg }}>
      ...
      <AmenitiesSection />
      <CTASection />
      <Footer pageType="property" bgColor={P.primary} textColor="#FFFFFF" propertyName="Hangaroa" />
    </div>
  );
}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <p
            ...
            style={body}
          >
            Understated Luxury with Ocean Views
          </p>
          <button
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              With an open floor that signifies the wideness of the ocean, the Kainga room merges the island's unique geography with local culture. Floor-to-ceiling windows invite the lights and sounds of the waves to interact with the decor.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Cypress logs, clay and volcanic stone are some of the noble and natural materials that offer an immersion in the Rapa Nui culture.
            </p>
          </div>
        </motion.div>
      </div>
...
function AmenitiesSection() {
  const amenities = [
    "Open floor plan with ocean views",
    "Floor-to-ceiling windows",
    "Cypress logs and volcanic stone",
    "Clay and natural materials",
    "Authentic Rapa Nui design",
    "Complimentary Wi-Fi",
    "A-la-carte breakfast service",
    "Access to island experiences",
  ];
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Experience Rapa Nui Culture
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Kainga connects you to the soul of Easter Island through authentic design and breathtaking ocean views.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation , Coming Soon"))}

/**
 * NAYARA BOCAS DEL TORO — Property Homepage
 * Panama — Caribbean overwater villas on a private island
...
const BOOKING_URL = BOOKING_URLS["bocas-del-toro"];

/* ── CDN Assets ── */
const CDN = {
  heroDesktop:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/bocas-hero-desktop_8a1ea433.mp4",
  heroMobile:
    "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/bocas-vertical-beach_a8134b71.mp4",
  logoWhite:

...
const BOCAS_ROOMS: RoomSliderCard[] = [
  {
    ...
    tagline: "The pinnacle of Caribbean overwater living",
    description: "Our most expansive overwater sanctuary, featuring a private infinity plunge pool that merges with the Caribbean horizon, an oversized sundeck with direct ocean access, indoor-outdoor rain shower, and floor-to-ceiling glass walls that frame endless turquoise views from every angle.",
    sqft: "1,200",
    sqm: "111",
    guests: "2 Adults",
  ...
  },
  {
    ...
    description: "A private overwater retreat where the sea becomes your living room. Step directly from your deck into crystal-clear Caribbean waters, relax in your plunge pool as tropical fish glide beneath you, and fall asleep to the gentle rhythm of waves against the stilts below.",
    sqft: "950",
    sqm: "88",
    guests: "2 Adults",
  ...
  },
  {
    ...
    description: "Perched high in the tropical canopy, these treehouse villas offer a rare perspective — waking to howler monkeys and toucans at eye level while the Caribbean Sea shimmers through the foliage. Private deck, plunge pool, and an open-air bathroom surrounded by nature.",
    sqft: "1,050",
    sqm: "97",
    guests: "2 Adults",
  ...
  },
  {
    ...
    label: "Premium Villa",
    tagline: "Coming Soon",
    description: "An exclusive new villa category currently under development — combining the best of overwater and treehouse living into one extraordinary residence. Details to be announced.",
    guests: "2 Adults",
    video: "",
    exploreLink: "/bocas-del-toro/rooms",
    bookingUrl: BOOKING_URLS["bocas-del-toro"],

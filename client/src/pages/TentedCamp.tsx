...
const ASSETS = {
  ...
  storyV: `${CDN}/tentreel4_bfa98c2e.mp4`,
  ...
  wildV: `${CDN}/tentreel4_bfa98c2e.mp4`,
  wildH: `${CDN}/tc-mainpool-vertical_81b6bb28.mp4`,

  // Tent reel videos
  tentReel1: `${CDN}/tentreel4_bfa98c2e.mp4`,
        ...
        >
          ...
          {section.badges && (
            <div className="mt-8 flex items-center justify-start gap-6 md:gap-8 -ml-1">
              ...
              {/* Green Globe */}
              <img
                src="/manus-storage/tented-badge-green-globe_a2a6d1d5.png"

...
const SECTIONS_BEFORE_REVIEW: CascadeSectionData[] = [
  ...
  },
  {
    ...
    verticalSrc: "",
    mobileVerticalSrc: "/manus-storage/tented-experiences-bridge_3e6ea462.jpg",
...
const SECTIONS_AFTER_REVIEW: CascadeSectionData[] = [
  {
    ...
    verticalSrc: "/manus-storage/tented-gastronomy-desktop-still_c11d717e.jpg",
    ...
    verticalOverlayButtons: {
      top: { explore: "Lapas Pool Bar", reserve: "", exploreLink: "/tented-camp/gastronomy", transparent: true },

...
const SECTIONS_BEFORE_REVIEW: CascadeSectionData[] = [
  ...
  },
  {
    ...
    body: "Cross hanging bridges suspended above the rainforest canopy, rappel down volcanic canyon walls on guided off-site excursions, or find your center with yoga sessions held on open-air platforms overlooking the jungle.",
    verticalSrc: "",

    ...
    <>
      ...
      <div className="py-10 md:py-16 px-0 bg-[#1a1a1a]">
        <div className="px-6 md:px-10 max-w-[1200px] mx-auto">
          <FadeIn>
            <motion.p initial={{ opacity: 0, letterSpacing: "0.05em" }} whileInView={{ opacity: 1, letterSpacing: "0.15em" }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-white/40 text-[11px] uppercase mb-6" style={{ ...body, fontWeight: 500 }}>Experiences</motion.p>
          </FadeIn>
          <SlideFromLeft delay={0.2}>
            <a href="https://blog.nayararesorts.com/pura-vida" target="_blank" rel="noopener noreferrer" className="group block p-5 rounded-lg border border-white/10 hover:border-white/25 hover:bg-white/5 transition-all">
  ...
  return (
    <>
      ...
      <div className="py-10 md:py-16 px-0 bg-[#1a1a1a]">
        <div className="px-6 md:px-10 max-w-[1200px] mx-auto">
          <FadeIn>
            <motion.p initial={{ opacity: 0, letterSpacing: "0.05em" }} whileInView={{ opacity: 1, letterSpacing: "0.15em" }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="text-white/40 text-[11px] uppercase mb-3" style={{ ...body, fontWeight: 500 }}>Wellness</motion.p>
          </FadeIn>
          <SlideFromLeft delay={0.15}>
            <a href="https://blog.nayararesorts.com/nature-based-wellness-at-nayara-resorts-how-deserts-rainforests-oceans-and-night-skies-shape-human-health" target="_blank" rel="noopener noreferrer" className="group block p-5 rounded-lg border border-white/10 hover:border-white/25 hover:bg-white/5 transition-all">
              <span className="text-[#c9b99a]/50 text-[9px] tracking-[0.15em] uppercase block mb-2" style={{ ...body, fontWeight: 600 }}>From the Journal</span>
        ...
        <div className={`${maxW} text-center`}>
          <ScaleIn>
            ...
            <div className="flex items-center justify-center gap-1.5 mb-4">
              {[...Array(5)].map((_, i) => (
                <motion.svg key={i} initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 + i * 0.1 }} className="w-5 h-5 text-[#c9b99a]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <LineWipe className="!bg-[#c9b99a]/30 max-w-[64px] mx-auto mb-8" />
          </ScaleIn>
          <FadeIn delay={0.4}>
            <blockquote className="max-w-2xl mx-auto">
              <p className="text-white/80 text-[15px] md:text-[17px] leading-relaxed italic mb-4" style={body}>"An extraordinary experience. The tents are beyond luxurious, the staff anticipates every need, and waking up to the sounds of the rainforest with Arenal Volcano in view is something you never forget."</p>
              <cite className="text-[#c9b99a]/60 text-[12px] tracking-[0.08em] not-italic" style={body}>— Andrew wrote a review, Apr 2</cite>
            </blockquote>
          </FadeIn>
          <FadeIn delay={0.5}>
            <a href="https://www.tripadvisor.com/Hotel_Review-g309226-d12099846-Reviews-Nayara_Tented_Camp-La_Fortuna_de_San_Carlos_Arenal_Volcano_National_Park_Province_of_Al.html" target="_blank" rel="noopener noreferrer" className="inline-block mt-8 px-6 py-2.5 rounded-full border border-[#c9b99a]/30 text-[#c9b99a] text-[11px] tracking-[0.15em] uppercase hover:bg-[#c9b99a]/10 transition-colors" style={{ ...body, fontWeight: 500 }}>Read All Reviews</a>
          </FadeIn>
        </div>
      </section>

...
const ASSETS = {
  ...
  heroMobile: "/manus-storage/tented-camp-hero-mobile_9d697a9b.mp4",
...
const TENTED_CAMP_ROOMS: RoomSliderCard[] = [
  {
    ...
    description: "Elevated above the rainforest canopy, each safari-style tent is a private sanctuary with panoramic volcano views, heated plunge pool, outdoor rain shower, and floor-to-ceiling mesh walls that dissolve the boundary between you and the jungle.",
    sqft: "1,700",
    sqm: "158",
    guests: "2 adults + 2 children",
    video: "/manus-storage/tented-accom-slider_54ecda10.mp4",
    photo: "/manus-storage/tented-accommodations-mobile_c0375a49.jpg",
  ...
  },
  {
    ...
    description: "Designed for families seeking an unforgettable rainforest adventure, these interconnected tents offer generous space, private plunge pools, and direct access to nature trails — all while keeping the safari-luxury experience intact for every generation.",
    sqft: "2,400",
    sqm: "223",
    guests: "2 adults + 3 children",
    video: "/manus-storage/family-tent-new_90ea0d30.mp4",
    photo: "/manus-storage/tented-family-tent-still_6b0cb029.jpg",
  ...
  },
  {
    ...
    description: "The ultimate Tented Camp experience — a multi-room residence with private pool, dedicated butler service, and panoramic views of the Arenal Volcano. Perfect for families or those seeking the most exclusive rainforest retreat.",
    sqft: "4,804",
    sqm: "446",
    guests: "4 adults + 2 children",
    video: "/manus-storage/tented-camp-grand-tent-reel_85820c73.mp4",
    photo: "/manus-storage/tented-grand-tent-still_7e2ae0a1.jpg",
  ...
  },
  {
    ...
    description: "Our most expansive accommodation — a standalone estate with multiple bedrooms, private pool, dedicated staff, and sweeping volcano views. Designed for multi-generational families and groups seeking complete privacy with full resort access.",
    sqft: "7,664",
    sqm: "712",
    guests: "Up to 12 adults",
    video: "/manus-storage/tc-residence-916_3c5deb23.mp4",
    photo: "/manus-storage/tented-residence-aerial_1e1e715a.jpg",
...
const SECTIONS_BEFORE_REVIEW: CascadeSectionData[] = [
  ...
  },
  {
    ...
    body: "Rappel down volcanic canyon walls on guided off-site excursions, or find your center with yoga sessions held on open-air platforms overlooking the jungle.",
    verticalSrc: "",
    mobileVerticalSrc: "/manus-storage/tented-experiences-bridges-new_47a6bbc7.jpg",
    mobileVerticalIsVideo: false,
    horizontalSrc: "/manus-storage/tented-experiences-new_cecbb25f.mp4",
    verticalIsVideo: true,
    horizontalIsVideo: true,
    verticalRatio: "3/4",
    horizontalRatio: "16/9",
...
const SECTIONS_AFTER_REVIEW: CascadeSectionData[] = [
  ...
  },
  {
    id: "nayara-by-night",
    label: "By Night",
    headline: "Henry's Bar",
    body: "An intimate speakeasy tucked within the rainforest canopy, Henry's Bar is where craft cocktails meet volcanic sunsets. Our mixologists draw on Costa Rica's botanical bounty , cacao, tropical fruits, artisanal spirits , to create an evening ritual as refined as the jungle is wild.",
    verticalSrc: "/manus-storage/tented-bynight-henrysbar_d1e7e7ed.jpg",
    mobileVerticalSrc: "/manus-storage/tented-bynight-henrysbar_d1e7e7ed.jpg",
    mobileVerticalIsVideo: false,

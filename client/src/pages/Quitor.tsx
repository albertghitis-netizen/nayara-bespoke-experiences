...
export default function Quitor() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Quitor offers a distinctive interpretation of desert luxury, combining the natural materials and desert views of the Catarpe experience with its own unique character and layout. Each element is carefully curated to create an intimate connection with the Atacama landscape.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Experience the raw beauty of the desert in a setting that honors both tradition and innovation.
            </p>
          </div>
        </motion.div>
      </div>

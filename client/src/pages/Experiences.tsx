...
const CDN = {
  ...
  heroHorizontal: "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/experiences-hero-geysers-audio_7e6b6a00.mp4",
};
    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end items-center pb-10 md:pb-16 px-6">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1 }} className="text-white/50 text-[13px] md:text-[15px] mt-4 tracking-[0.12em] uppercase" style={{ ...body, fontWeight: 500 }}>
          Adventures Shaped by Destination
        </motion.p>
      </div>
    </section>
  );
  ...
  return (
    <section className="py-16 md:py-24 px-6 md:px-10">
      <div className="max-w-[900px] mx-auto">
        <FadeIn>
          <p className="text-[#3a2a1a]/35 text-[10px] tracking-[0.3em] uppercase mb-4" style={{ ...body, fontWeight: 600 }}>The Nayara Experience</p>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-[#3a2a1a]/30 text-[9px] tracking-[0.2em] uppercase" style={{ ...body, fontWeight: 600 }}>
                        {ex.propertyName}
                      </span>
                      <span className="text-[#3a2a1a]/15">·</span>
                      <span className="text-[#3a2a1a]/30 text-[9px] tracking-[0.15em] uppercase" style={{ ...body, fontWeight: 500 }}>
                        {ex.category}
                      </span>
                    </div>

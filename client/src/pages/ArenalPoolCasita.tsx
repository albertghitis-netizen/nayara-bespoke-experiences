/*
 * ARENAL POOL CASITA — Deeper Room Detail Page (placeholder)
 * Will be built out when content arrives
 * Hero video: arenal-pool-casita-hero.mp4
 * Colors: Gardens palette (green)
 */
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: P.bg }}>
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-16 pb-12 md:pb-20">
          ...
          <motion.p
            ...
            style={body}
          >
            A private garden retreat with plunge pool — content coming soon
          </motion.p>
        </div>
      ...
      <section className="py-20 md:py-32 px-6 md:px-16 max-w-4xl mx-auto text-center">
        ...
        >
          The Arenal Pool Casita detail page will feature the family-friendly garden villas at Nayara Gardens — each with a private plunge pool, tropical garden views, and easy access to the resort's adventures. Check back soon.
        </p>
      </section>

/**
 * CKELAR RESTAURANT — Dining Detail Page
...
export default function CkelarRestaurant() {
  return (
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <p
            ...
            style={body}
          >
            A Culinary and Wine Journey in the Desert
          </p>
          <button
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Seasonal, local ingredients get transformed into modern dishes inspired by the culinary culture of Chile. Our chefs craft menus that celebrate the unique flavors of the Atacama region.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Experience a culinary and wine journey that honors both tradition and innovation in the heart of the desert.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Discover Desert Cuisine
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Join us at Ckelar for an unforgettable culinary experience in the Atacama Desert.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation — Coming Soon"))}

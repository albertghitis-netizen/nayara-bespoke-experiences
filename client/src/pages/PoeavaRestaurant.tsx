/**
 * POERAVA RESTAURANT , Dining Detail Page
...
export default function PoeavaRestaurant() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Poerava celebrates the culinary traditions of Rapa Nui with fresh seafood and local ingredients. Our chefs honor island heritage while creating modern interpretations of traditional dishes.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Experience the flavors of Easter Island in an intimate setting that connects you to the island's rich cultural legacy.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Taste Island Heritage
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Discover the authentic flavors of Rapa Nui at Poerava restaurant.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation , Coming Soon"))}

/*
 * NAYARA TENTED CAMP MACH 1 — Arenal, Costa Rica (Light Transitions)
...
export default function TentedCampMach1() {
  return (
  ...
  return (
    <section id="story" className="py-10 md:py-16" style={{ backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/tented-texture_244a75bf.png)', backgroundSize: '600px auto', backgroundRepeat: 'repeat' }}>
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-0 items-start mb-16">
        <FadeIn className="md:flex-1 px-6 md:pl-10 md:pr-16 lg:pl-[max(2.5rem,calc((100vw-1200px)/2+2.5rem))]">
        ...
        <FadeIn delay={0.2} className="md:flex-1 w-full md:w-auto">
          <div className="overflow-hidden md:rounded-l-lg">
            <img src={CDN.s1} alt="Luxury tented accommodation at Nayara" className="w-full object-cover" style={{ aspectRatio: "3/4" }} loading="lazy" />
          </div>
        </FadeIn>
      </div>
      ...
      <FadeIn delay={0.3}>
        <div className="overflow-hidden w-full">
          <img src={CDN.s2} alt="Rainforest canopy at Nayara Tented Camp" className="w-full object-cover" style={{ aspectRatio: "16/9" }} loading="lazy" />
        </div>
      </FadeIn>
...
function TentedCampAccommodationsSection() {
  const roomTypes = [
    { id: "tent", name: "", image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/tented-camp-exterior-aerial_cc5ac763.png" },
    ...
    <>
      ...
      <section id="experiences" className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-end pb-16 md:pb-24">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-10">
          <FadeIn>
            <h2 className="text-white text-3xl md:text-4xl lg:text-5xl leading-tight mb-6" style={{ ...heading, fontWeight: 400 }}>Bespoke Experiences</h2>
          </FadeIn>
          <FadeIn delay={0.3}>
            <a href="/tented-experiences" className="text-white/70 hover:text-white text-sm tracking-[0.08em] uppercase transition-colors cursor-pointer underline" style={{ ...body, fontWeight: 400 }}>Explore More</a>
          </FadeIn>
        </div>
      </section>
    </>
...
/* ═══ SUSTAINABILITY — Podcast card + full-width image ═══ */
    ...
    <>
      ...
      <section className="relative py-0 px-0 mb-0">
        <div className="overflow-hidden">
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/SustainabilityTentedHero_67d62aef.jpg" alt="Sustainability - Light Footprint, Lasting Impact" className="w-full h-auto" loading="lazy" />
        </div>
        ...
        <div className="absolute bottom-8 md:bottom-16 left-0 right-0">
          <div className="max-w-[1200px] mx-auto px-6 md:px-10 flex justify-end">
            <a href="/tented-camp/sustainability" className="text-white/70 hover:text-white text-sm tracking-[0.08em] uppercase transition-colors cursor-pointer underline" style={{ ...body, fontWeight: 400 }}>Explore More</a>
          </div>
        </div>
      </section>
    </>
...
/* ═══ WELLNESS — Blog card + full-screen video ═══ */
  ...
  return (
    <>
      ...
      <section id="wellness" className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-end pb-16 md:pb-24">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-10">
          <FadeIn>
            <h2 className="text-white text-3xl md:text-4xl lg:text-5xl leading-tight" style={{ ...heading, fontWeight: 400 }}>Nurtured by Nature</h2>
          </FadeIn>
          <FadeIn delay={0.3}>
            <a href="/tented-camp/wellness" className="text-white/70 hover:text-white text-sm tracking-[0.08em] uppercase transition-colors cursor-pointer underline mt-6" style={{ ...body, fontWeight: 400 }}>Explore More</a>
          </FadeIn>
        </div>
      </section>
    </>
...
/* ═══ GASTRONOMY — Blog card + full-width image ═══ */
function GastronomySection() {
  return (
    <>
      ...
      <section className="relative py-0 px-0 mb-0">
        <div className="overflow-hidden">
          <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663090891297/aPU7TBha6XBXzi9S9Q7tf2/atasteofplace_f64f6f71.jpg" alt="A Taste of Place - The Table" className="w-full h-auto" loading="lazy" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/50" />
        <div className="absolute bottom-8 md:bottom-16 left-0 right-0 flex flex-col items-center text-center px-6">
          <FadeIn>
            <h2 className="text-white text-2xl md:text-3xl lg:text-4xl leading-tight mb-4" style={{ ...heading, fontWeight: 400 }}>A Taste of Place</h2>
          </FadeIn>
          <FadeIn delay={0.2}>
            <a href="/tented-camp/the-table" className="text-white/70 hover:text-white text-sm tracking-[0.08em] uppercase transition-colors cursor-pointer underline" style={{ ...body, fontWeight: 400 }}>Explore More</a>
          </FadeIn>
        </div>
      </section>
    </>
        ...
        <div className={`${maxW} text-center`}>
          <FadeIn>
            ...
            <div className="flex items-center justify-center gap-1.5 mb-4">
              {[...Array(5)].map((_, i) => (
                <svg key={i} className="w-5 h-5 text-[#8b6f47]" fill="currentColor" viewBox="0 0 20 20">
    ...
    <section id="gallery" className="py-10 md:py-16 px-0">
      <div className="px-6 md:px-10 max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3 auto-rows-auto">
          {images.map((img, i) => (
            <FadeIn key={i} delay={i * 0.05} className={i === 1 ? "col-span-2 md:col-span-2 row-span-2" : ""}>
...
/* ═══ PARALLAX VIDEO — Full-screen stylistic video ═══ */
function ParallaxVideoSection() {
  return (
    <section className="relative w-full h-screen overflow-hidden hidden md:flex items-center justify-center bg-black">
      <div className="absolute inset-0 w-full h-full">
        <NativeVideo

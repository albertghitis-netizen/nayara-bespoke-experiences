/*
 * RAINFOREST POOL VILLA — Deeper Room Detail Page (placeholder)
 * Will be built out when content arrives
 * Hero video: rainforest-pool-villa-hero.mp4
 * Colors: Gardens palette (green) — same property as Arenal Pool Casita
 */
...
const heroVideo = "/manus-storage/rainforest-pool-villa-hero_f9b4b9eb.mp4";
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: P.bg }}>
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-16 pb-12 md:pb-20">
          ...
          <motion.p
            ...
            style={body}
          >
            Immersed in the canopy — content coming soon
          </motion.p>
        </div>
      ...
      <section className="py-20 md:py-32 px-6 md:px-16 max-w-4xl mx-auto text-center">
        ...
        >
          The Rainforest Pool Villa detail page will feature the premium villas at Nayara Gardens — nestled in the rainforest canopy with private pools and panoramic volcano views. Check back soon.
        </p>
      </section>

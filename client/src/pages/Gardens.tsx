...
const GARDENS_ROOMS: RoomSliderCard[] = [
  ...
  },
  {
    ...
    video: "/manus-storage/gardens-rpv-ultra_a69ec2b0.mp4",
  ...
  return (
    <section className={`relative w-full overflow-hidden ${isMobile ? '' : 'h-screen'}`} style={isMobile ? { aspectRatio: '9/16' } : undefined}>
      <div className="absolute inset-0">
        {isMobile ? (
          <img src={mobileHeroStill} alt="Nayara Gardens" className="w-full h-full object-cover" loading="eager" decoding="async" />
        ) : (
          <BlobVideo
          src={CDN.heroDesktop}
    ...
    <section id="wellness" style={{ backgroundColor: isMobile ? "#F6FFEE" : "#000" }}>
      ...
      <div className="relative w-full">
        <div style={{ aspectRatio: "16/9" }}>
          <NativeVideo src="/manus-storage/gardens-wellness-stitched_52dda415.mp4" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-16 lg:pb-20 px-16 lg:px-24">
          ...
          <AnimateOnScroll variants={fadeUp} delay={0.1}>
            <h2 className="mb-6">
              <span className="block text-[2rem] lg:text-[2.5rem] leading-[1.05] tracking-wide text-white" style={{ fontFamily: "var(--font-display)", fontWeight: 400 }}>
      ...
      <div className="max-w-[1000px] mx-auto">
        ...
        <AnimateOnScroll variants={fadeUp} delay={0.4}>
          <div className="mt-12 md:mt-16 rounded-lg overflow-hidden" style={{ border: `1px solid ${PALETTE.primary}15` }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.5!2d-84.688747!3d10.5033502!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa00be176806861%3A0x5e479b6bbb7545d8!2sNayara%20Gardens%20Hotel%20and%20Spa!5e0!3m2!1sen!2scr!4v1700000000000!5m2!1sen!2scr"
              width="100%"
              height="280"
              style={{ border: 0 }}
              allowFullScreen
    ...
    <section id="experiences" style={{ backgroundColor: isMobile ? "#F6FFEE" : "#000" }}>
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-16 lg:pb-20 px-16 lg:px-24">
          ...
          <AnimateOnScroll variants={fadeUp} delay={0.3}>
            <div className="flex flex-wrap gap-3 mt-6">
              <a href="/curated-excursions?from=gardens" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-white/40 backdrop-blur-md text-white text-[11px] tracking-[0.15em] uppercase font-medium transition-all hover:bg-white/10 w-fit" style={{ fontFamily: "var(--font-body)" }}>
                Explore On-Site Experiences
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
              </a>
              <a href="/explore-arenal?from=gardens" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-white/40 backdrop-blur-md text-white text-[11px] tracking-[0.15em] uppercase font-medium transition-all hover:bg-white/10 w-fit" style={{ fontFamily: "var(--font-body)" }}>
      ...
      <div style={{ backgroundColor: "#F6FFEE" }}>
        <div className="px-5 pt-10 pb-6">
          ...
          <a href="/explore-arenal?from=gardens" className="inline-flex items-center gap-2 mt-5 px-4 py-2.5 rounded-full border border-[#286241]/40 text-[11px] tracking-[0.15em] uppercase font-medium w-fit" style={{ fontFamily: "var(--font-body)", color: "#286241" }}>
            Explore Experiences
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
          </a>
        </div>

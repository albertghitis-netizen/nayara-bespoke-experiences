/**
 * KALOA LOUNGE RESTAURANT — Dining Detail Page
...
export default function KaloaLoungeRestaurant() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="relative overflow-hidden rounded-sm aspect-[4/3]" style={{ backgroundColor: P.primary }}>
            <div className="w-full h-full flex items-center justify-center">
              <p style={{ ...body, color: P.white }}>Lounge Image Coming Soon</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Kaloa Lounge is your perfect evening retreat with craft cocktails and island-inspired drinks. Relax in a sophisticated atmosphere while enjoying ocean views and the warm island breeze.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              Experience the spirit of Rapa Nui with expertly crafted libations and the vibrant energy of island life.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Unwind in Island Style
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Join us at Kaloa Lounge for craft cocktails and authentic island vibes.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation — Coming Soon"))}

 ...
 * Desert palette — S Certification
 * Structure: Hero → S Certification → Video/Story → Journal → Footer
 * Mirrors TentedCampSustainability layout exactly
 */
...
const CDN = {
  heroVideo: `${CDN_BASE}/Video_Nayara_Atacama00007_8576aa55.MP4`,
};
  ...
  return (
    <div className="relative overflow-hidden" style={{ aspectRatio: "2/1" }}>
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{ backgroundColor: "rgba(111, 70, 61, 0.85)" }} />
      </div>
    ...
    <section className="py-16 md:py-24 px-6 md:px-10" style={{ backgroundColor: PALETTE.gradientEnd }}>
      <div className={maxW}>
        <AnimateOnScroll variants={fadeUp}>
          ...
          <a
            href="https://blog.nayararesorts.com/wildlife-conservation-in-chiles-atacama-desert-and-easter-island"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[12px] tracking-[0.1em] transition-colors"
            style={{ fontFamily: "var(--font-body)", fontWeight: 500, color: `${PALETTE.primary}90` }}
          >
            Read: Wildlife Conservation in Chile's Atacama Desert
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M5 12h14M12 5l7 7-7 7" />
            </svg>
          </a>

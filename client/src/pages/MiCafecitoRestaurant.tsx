/**
 * MICAFECITO RESTAURANT — Dining Detail Page
...
export default function MiCafecitoRestaurant() {
  const restaurant = restaurants.find((r) => r.slug === "mi-cafecito");
  ...
  return (
    <div className="min-h-screen" style={ { backgroundColor: BRAND.pageBackground }}>
      ...
      <CTASection />
      <Footer pageType="property" bgColor={palette.primary} />
    </div>
  );
}

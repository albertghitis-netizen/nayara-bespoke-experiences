/**
 * MAUNGA (MOUNTAIN) , Room Detail Page
...
export default function Maunga() {
  return (
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Built on two levels, our Maunga room is the perfect space for families. The open floor concept and floor-to-ceiling windows invite the light and allow you to enjoy magnificent views of the ocean while listening to the sounds of the waves.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              A private outdoor terrace lets you appreciate the natural beauty of the Island. The room was designed with both comfort and connection to nature in mind.
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Maunga offers spacious, comfortable accommodation with stunning views for the whole family.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation , Coming Soon"))}

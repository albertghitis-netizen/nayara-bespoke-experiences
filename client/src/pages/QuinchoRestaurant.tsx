/**
 * QUINCHO RESTAURANT , Dining Detail Page
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-0 items-start">
        ...
        >
          <div className="p-8 md:p-12 rounded-sm" style={{ backgroundColor: P.bg }}>
            ...
            >
              Experience the tradition of Asado, the South American barbecue, in our outdoor pavilion. Enjoy grilled meats and local specialties prepared over open flames under the desert sky.
            </p>
            ...
            <p
              ...
              style={{ ...body, color: P.textSoft }}
            >
              The Quincho offers an authentic culinary experience surrounded by the natural beauty of the Atacama landscape.
            </p>
          </div>
        </motion.div>
      </div>
...
function OfferingsSection() {
  const offerings = [
    "Traditional Asado preparation",
    "Grilled meats and specialties",
    "Open-fire cooking",
    "Desert views",
    "Outdoor pavilion setting",
    "Wine selections",
    ...
    <section className="py-20 md:py-28 px-6 md:px-10" style={{ backgroundColor: P.primary }}>
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          >
            Experience Traditional Asado
          </h2>
          <p
            className="text-base md:text-lg leading-relaxed mb-10"
            style={{ ...body, color: P.white + "DD" }}
          >
            Join us at Quincho for an authentic South American barbecue experience.
          </p>
          <button
            onClick={() => import("sonner").then(({ toast }) => toast("Reservation , Coming Soon"))}
